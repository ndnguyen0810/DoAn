...
namespace QuanLyBaoChi.DAO
{
	public class TapChiDAO
	{
		...
		{
			string query = string.Format("UPDATE BAOTAPCHI SET  TENTAPCHI = N'{1}', DIACHITC=N'{2}',ID_PHATHANH={3}, EMAIL_TC='{4}', SDT_TC= '{5}' WHERE ID_TAPCHI={0}", id_TC,tenTC, dichiTC, id_phathanh, email_tc, teL);

...
namespace QuanLyBaoChi.DAO
{
    public class BaiBaoDAO
    {
       private static BaiBaoDAO instance;
		...
		{
			string query = string.Format("UPDATE BaiBao SET TenBaiBao = N'{1}',NOIDUNGCHINH=N'{2}', NGAYDANG='{3}', ID_TAPCHI={4}, ID_THELOAI={5},ID_NHABAO={6},ID_BAIVIET={7} where ID_BaiBao={0}",idbb, ten, nd, time, idtc, istl, idnb, idbv);
